...
/* harmony import */ var _components_widget_widget_list_sortable_directive__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/widget/widget-list/sortable.directive */ "./src/app/components/widget/widget-list/sortable.directive.ts");
/* harmony import */ var _components_widget_widget_list_order_by_pipe_pipe__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/widget/widget-list/order-by-pipe.pipe */ "./src/app/components/widget/widget-list/order-by-pipe.pipe.ts");
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./safe.pipe */ "./src/app/safe.pipe.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_widget_widget_list_sortable_directive__WEBPACK_IMPORTED_MODULE_27__["SortableDirective"],
                _components_widget_widget_list_order_by_pipe_pipe__WEBPACK_IMPORTED_MODULE_28__["OrderByPipe"]
            ],
            imports: [
...
var PageEditComponent = /** @class */ (function () {
    ...
    PageEditComponent.prototype.updatePage = function () {
        ...
        var new_page = new _models_page_model_client__WEBPACK_IMPORTED_MODULE_5__["Page"](this.pageID, this.page.name, this.page.websiteId, this.page.title);
        this.pageService.updatePage(this.pageID, new_page).subscribe(function (page) {
            _this.page = page;
    ...
    PageEditComponent.prototype.deletePage = function () {
        var _this = this;
        this.pageService.deletePage(this.pageID).subscribe(function () { return _this.router.navigate(['../'], { relativeTo: _this.activatedRoute }); });
    };
...
var PageNewComponent = /** @class */ (function () {
    ...
    PageNewComponent.prototype.createPage = function () {
        ...
        this.pageService.createPage(this.websiteID, new_page).subscribe(function () { return _this.router.navigate(['../'], { relativeTo: _this.activeRoute }); });
    };
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.updateUser = function () {
        ...
        this.userService.updateUser(user).subscribe(function (new_user) {
            _this.user = new_user;
        });
        // console.log(user);
...
var WebsiteEditComponent = /** @class */ (function () {
    ...
    WebsiteEditComponent.prototype.ngOnInit = function () {
        ...
        this.websiteService.findWebsitesById(this.userId, this.wid).subscribe(function (website) {
            console.log(website);
    ...
    WebsiteEditComponent.prototype.updateWebsite = function () {
        ...
        this.websiteService.updateWebsite(this.userId, this.wid, this.website).subscribe(function (website) {
            _this.website = website;
        });
    };
    WebsiteEditComponent.prototype.deleteWeb = function () {
        ...
        this.websiteService.deleteWebsite(this.userId, this.wid).subscribe(function () { return _this.router.navigate(['../'], { relativeTo: _this.activatedRoute }); });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('f'),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgForm"])
...
var WidgetHeaderComponent = /** @class */ (function () {
    ...
    WidgetHeaderComponent.prototype.delete = function () {
        ...
        this.widgetService.deleteWidget(this.wgid)
            .subscribe(function (data) { return _this.route.navigate(['/user', _this.userId, 'website', _this.websiteId, 'page', _this.pageID, 'widget']); }, function (error) { return console.log(error); });
    };
...
var WidgetYoutubeComponent = /** @class */ (function () {
    ...
    WidgetYoutubeComponent.prototype.ngOnInit = function () {
        ...
        if (this.wgid === undefined) {
            this.widget = new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_3__["Widget"](undefined, 'YOUTUBE', this.pageID, '', '', '', '');
        }
        else {
...
var WebsiteService = /** @class */ (function () {
    ...
    WebsiteService.prototype.createWebsite = function (userId, website) {
        var body = website;
        var url = 'http://localhost:8080/api/user/' + userId + '/website';
        console.log(body);
    ...
    WebsiteService.prototype.updateWebsite = function (userId, websiteId, website) {
        var url = 'http://localhost:8080/api/user/' + userId + '/website/' + websiteId;
        var body = website;
